...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/2048_ai/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/2048_ai/archive/master.zip", tmp)
    file += "master"
